...
#+end_src
*** Launch applications (called in applications menu)
#+begin_src emacs-lisp
...
only works for firefox atm, other applications need to be added manually
#+begin_src emacs-lisp
...
#+end_src
** Require packages and global keys
#+begin_src emacs-lisp
